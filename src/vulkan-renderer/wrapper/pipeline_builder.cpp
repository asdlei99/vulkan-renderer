...
GraphicsPipelineBuilder &
GraphicsPipelineBuilder::set_color_blend(const VkPipelineColorBlendStateCreateInfo &color_blend_state) {
    m_color_blend_sci = color_blend_state;
    return *this;
}
...
GraphicsPipelineBuilder &
GraphicsPipelineBuilder::set_input_assembly(const VkPipelineInputAssemblyStateCreateInfo &input_assembly_sci) {
    m_input_assembly_sci = input_assembly_sci;
    return *this;
}
